<template>
  <page-layout title="推广用户详情">
    <a-card :bordered="false">
      <detail-list title="用户信息">
        <detail-list-item term="注册时间">{{userData.userInfo.createTime | FormatDate}}</detail-list-item>
        ...
        <detail-list-item term="联系电话">{{userData.userInfo.mobile}}</detail-list-item>
      ...
      <detail-list title="推广信息">
        ...
        <detail-list-item term="类型">{{userData.promoterInfo.level==="VIP"?"超级推广员":""}}</detail-list-item>
